...
public class Magpie4
{
    ...
    public String getResponse(String statement)
    {
        ...
        else
        {
            ...
            //System.out.println(findKeyword(statement, "I", 0));
            ...
            else if (findKeyword(statement, "I", 0) < psn && psn > 0)
            {
    ...
    private String getRandomResponse()
    {
        ...
        {
            response = "I guess that's alright.";
        }
        ...
        {
            response = "That's very interesting.";
        }
